              ...
              <tbody>
                {pigSales.map((sale, i) => (
                  <tr key={sale.id} className="border-b border-gray-50 dark:border-gray-700 last:border-0 hover:bg-gray-50/50 dark:hover:bg-gray-700/30">
                    ...
                    <td className="px-6 py-3 text-gray-700 dark:text-gray-300 text-right">{fmtKg(sale.weight_kg)}</td>
                ...
                <tr className="border-t-2 border-gray-200 dark:border-gray-600 bg-gray-50 dark:bg-gray-900 font-semibold">
                  <td className="px-6 py-3 text-right text-xs text-gray-500 dark:text-gray-400">Total</td>
                  <td className="px-6 py-3 text-right text-gray-700 dark:text-gray-300">{fmtKg(totalPigSalesKg)} kg</td>
                  <td className="px-6 py-3" />
