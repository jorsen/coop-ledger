...
SELECT id, 1625, '2026-01-01' FROM feed_types WHERE name = 'STARTER LUNTIAN 50KLS'  UNION ALL
SELECT id, 1595, '2026-01-01' FROM feed_types WHERE name = 'STARGROW LUNTIAN 50KLS' UNION ALL
SELECT id, 1575, '2026-01-01' FROM feed_types WHERE name = 'GROWER LUNTIAN 50KLS'   UNION ALL
